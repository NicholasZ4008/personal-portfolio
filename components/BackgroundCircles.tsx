  ...
  return (
    ...
    transition={{
     ...
     className ="relative flex justify-center items-center">
      <div className = "absolute border border-[#F7AB08] rounded-full h-[200px] w-[200px] mt-52 animate-ping"/>
      ...
      <div className = "rounded-full border border-[#F7AB08] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse"/>
